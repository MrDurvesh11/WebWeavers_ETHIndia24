...
import { IPOAllocationChart } from "@/components/ipo-allocation-chart";
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card>
          <CardHeader>
            <CardTitle>IPO Allocation Distribution</CardTitle>
            <CardDescription>Overview of current IPO allocations</CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Latest IPO allocation activities</CardDescription>
          </CardHeader>
          <CardContent>
            <RecentTransactions />
          </CardContent>
